...
# --------------------------------------------------------------------
# Install act (To run your GitHub Actions locally)
# --------------------------------------------------------------------

WORKDIR /software
RUN git clone https://github.com/nektos/act.git
WORKDIR /software/act
RUN make install
...
# Optional: add sudo privileges to the devops user
...
# --------------------------------------------------------------------
# Set the default command and user
# --------------------------------------------------------------------
